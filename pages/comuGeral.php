...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Dados do formulário
    $remetente = $_POST['remetente_gera'];
    $assunto = $_POST['assunto_emailGeral'];
    $corpoEmail = $_POST['questionTextGer'];
    ...
    foreach ($admins as $admin) {
        sendEmailToMember($myAccountEmail, $admin->getEmail(), $corpoEmail, $assunto, $emailRemetente);
    }
