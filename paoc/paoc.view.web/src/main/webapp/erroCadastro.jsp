                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" align="center"">
                                    <div class="hero__caption">
                                        <h1 data-animation="fadeInLeft" data-delay="0.2s">Algo deu Errado 😢 <br> "<%= session.getAttribute("msg")%>"</h1>
                                        <p data-animation="fadeInLeft" data-delay="0.4s">Corrija o erro e tente novamente!</p>
                                        <a href="register.html" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">Se inscreva!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
