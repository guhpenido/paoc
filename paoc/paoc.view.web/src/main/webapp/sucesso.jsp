<%-- 
    ...
    Created on : 17 de mai. de 2023, 22:26:45
    Author     : gugup
--%>
...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <title>SUCESSO! | Olímpiada do Conhecimento | CEFET-MG</title>
        ...
        <link rel="stylesheet" href="elementos/css/style.css">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" align="center"">
                                    <div class="hero__caption">
                                        <h1 data-animation="fadeInLeft" data-delay="0.2s">Sucesso!  🎉 <br> Equipe "<%= session.getAttribute("nomeEquipe")%>" cadastrada!</h1>
                                        <p data-animation="fadeInLeft" data-delay="0.4s">Sua equipe está sob aprovação, aguarde mais informações por E-Mail.</p>
                                        <a href="index.html" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">Ir para a Home</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row d-flex align-items-center">
                                <div class="col-xl-12 ">
                                    <div class="footer-copy-right text-center">
                                        <p>
                                            Olímpiadas do Conhecimento | CEFET-MG</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
